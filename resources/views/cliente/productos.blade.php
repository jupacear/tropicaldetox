...
<body>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="crearPersonalizados"
                                    data-dismiss="modal"
                                    onclick="actualizarTotalCarrito(true); mostrarAlertaExitosa('Producto agregado al carrito exitosamente');">
                                    Crear
                                </button>
    ...
    $(document).on('click', '.agregar-insumo', function() {
        ...
        if ($('.insumos_selecionados li').length < maxSeleccionados) {
            ...
            var insumoPrecio = parseFloat($(this).closest('tr').find('td:nth-child(4)').text().match(/\d+/)[0]);
            ...
            $('.lista-insumos-seleccionados').append(listItem);

            // Recalcular el total de insumos seleccionados
    ...
    $('#crearPersonalizados').click(function() {
        ...
        $('.lista-insumos-seleccionados li').each(function() {
